var scriber = (function() {
	...
	function Element(type) {
		...
		this.toDOMElement = function() {
			...
			for (var i = 00 ; i < this.elements.length ; i++) {
				elem.appendChild(this.elements[i].toDOMElement());
			}
			return elem;
		};
		...
		this.toString = function() {
			return this.toDOMElement().outerHTML;
		}
	...
	/**
	 * Returns as DOMElement
	 * @return DOMElement
	 */
	exports.toDOMElement = function() {
		return root.toDOMElement();
	};
